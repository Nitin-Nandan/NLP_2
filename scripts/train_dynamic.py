...
if __name__ == "__main__":
    ...
    # Explicitly activate the newly parameterized engine block checking to seamlessly decouple dropout
    val_acc, val_f1 = evaluate(model, val_loader, device, dynamic_dropout=True)
